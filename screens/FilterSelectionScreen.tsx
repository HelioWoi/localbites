            ...
            <div className="text-center space-y-3 px-4">
              ...
              <div className="pt-2 border-t border-white/10 space-y-2">
                ...
                <p className="text-[10px] text-white/50 mb-1">
                  Built with <span className="text-orange-500">🧡</span> in Australia | <a href="mailto:contact@menulove.com.au" className="text-orange-400 hover:text-orange-300 transition-colors">contact@menulove.com.au</a>
                </p>
