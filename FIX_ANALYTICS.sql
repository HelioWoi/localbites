-- =====================================================
-- FIX PARTNER ANALYTICS - Execute este SQL no Supabase
-- =====================================================
-- Este arquivo cria todas as funções necessárias para o analytics funcionar
...
-- 4) Get Peak Hours (Brisbane timezone)
...
-- =====================================================
-- TESTE: Execute este comando para verificar se funciona
-- =====================================================
-- Substitua 'SEU_RESTAURANT_ID' pelo ID do seu restaurante
-- SELECT * FROM get_partner_summary('SEU_RESTAURANT_ID', NOW() - INTERVAL '7 days', NOW());
